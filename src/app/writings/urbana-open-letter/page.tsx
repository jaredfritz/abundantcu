...
const claims: { claim: string; response: React.ReactNode[] }[] = [
  {
    ...
    response: [
      <>
        ...
        {" "}(<a href="https://lewis.ucla.edu/research/market-rate-development-impacts/" target="_blank" rel="noreferrer" className="text-blue-600 underline underline-offset-2 hover:opacity-80">UCLA Lewis Center</a>,{" "}
        <a href="https://www.americanprogress.org/article/build-baby-build-a-plan-to-lower-housing-costs-for-all/" target="_blank" rel="noreferrer" className="text-blue-600 underline underline-offset-2 hover:opacity-80">American Progress</a>).
